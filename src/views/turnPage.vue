...
export default {
  ...
  mounted() {
    this.handleTabletChange(this.media);
    this.media.addListener(this.handleTabletChange);
  },
  methods: {
...
$images: url("https://picsum.photos/420/300?random=1"), url("https://picsum.photos/420/300?random=2"), url("https://picsum.photos/420/300?random=3"),
  url("https://picsum.photos/420/300?random=4"), url("https://picsum.photos/420/300?random=5"), url("https://picsum.photos/420/300?random=1");
